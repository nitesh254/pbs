...
<li>
  ...
  <nav>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="col-md-6 center-block contact" id="contact">
            <!-- <form id="ajax-contact-form" method="post">
              <div id="fields1"></div>
              <div id="note1"></div>
              <label class="labelformat">Your Name :</label>
              <div class="clear"></div>
              <input
                type="text"
                name="name"
              ...
              />
              <div class="clear"></div>
              <label class="labelformat">Your Email :</label>
              <div class="clear"></div>
              <input type="text" name="email" class="textbox" />
              <div class="clear"></div>
              <label class="labelformat">Your Phone :</label>
              <div class="clear"></div>
              <input
                type="text"
                name="contact"
              ...
              />
              <div class="clear"></div>
              <label class="labelformat">Your Message :</label>
              <div class="clear"></div>
              <textarea class="textarea" name="message"></textarea>
              <div class="clear"></div>
              <label class="labelformat"></label>
              <div class="clear"></div>
            ...
            <div class="form-container" id="frmcontact">
             <!--<form id="contact" action="" method="post"> -->
                ...
                <h3>Register For Pune Business School - Master Class Series</h3>
                <fieldset>
                    <span id="w3lName-info" class="info"></span>
                  <input
                ...
                <fieldset>
                    <span id="w3lSender-info" class="info"></span>
                  <input
                ...
                <fieldset>
                    <span id="w3lnum-info" class="info"></span>
                  <input
                ...
                <fieldset>
                    <span id="w3lMessage-info" class="info"></span>
                  <textarea
                    placeholder="If any query/doubt, please write here"
                    id="w3lMessage"
                    name="w3lMessage"
                    tabindex="5"
                    required
          ...
          <div class="col-md-3">
            <h4>Upcoming Session</h4>  
              <a href="">
            <img
              src="./images/Master Class Series Chetan Bhagat.jfif"
              style="border-radius: 6px; transform: scale(0.8);"
              class="img-rounded img-responsive"
              height="250px" width="300px"
              alt="Master Class Series"
            /></a>
          </div>
          ...
          <div class="col-md-3">
              ...
              <a href="">
            <img
              src="./images/PBS Master Class by Trupti Jadhav.jpg"
              style="border-radius: 6px; transform: scale(0.8);"
              class="img-rounded img-responsive"
              height="250px" width="300px"
              alt="Master Class Series"
  ...
  <div class="row">
        <div class="col-md-12">
          ...
          <div class="col-md-3">
              ...
              <a href="https://youtu.be/9lIRFcpv5Bs">
            <img
              src="./images/PBS Master Class Series.png"
              style="border-radius: 6px; transform: scale(0.8);"
              class="img-rounded img-responsive"
              height="250px" width="300px"
              alt="Master Class Series"
          ...
          <div class="col-md-3">
               <h4>Previous Session</h4>  
              <a href="https://youtu.be/IqhRPCAOh2E">
            <img
              src="./images/Pune Business School Master Class Series.jfif"
              style="border-radius: 6px; transform: scale(0.8);"
              class="img-rounded img-responsive"
              height="250px" width="300px"
              alt="Master Class Series"
