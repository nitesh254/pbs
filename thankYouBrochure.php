...
<html lang="en">
  ...
  <head>
    ...
    <meta charset="utf-8" />
    <title>
      Apply | Pune Business School | Top Business School in Pune
    </title>
    <meta
      name="description"
...
<li>
  ...
  <div class="contact" style="margin-bottom: 50px;">
            <div class="container">
                ...
                <h2 style="margin: 40px 0px 20px 0px;">Your E-Book is downloading... <a href="/Documents/Brochure_Compress.pdf" target="_blank">Click here</a> if the download wasn't started automatically. You can message us anytime if you have any queries.</h2>
            </div>
        </div>
        ...
        <script type='text/javascript'>
            $(document).ready(function(){
                window.open('/Documents/Brochure_Compress.pdf', '_blank')
            })
        </script>
