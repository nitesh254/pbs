...
<html lang="en">
  ...
  <head>
    ...
    <meta charset="utf-8" />
    <title>
      Alumni | Pune Business School | Top Business School in Pune | Best PGDM College in Pune
    </title>
    <meta
      name="description"
...
<li>
    ...
    <div class="container" id="blog">
      <h2 class="content text-center" style="color: rgb(157, 18, 20)">
        DISTINGUISHED ALUMNI
      </h2>
            <div class="row alumni-dist text-center">
        <div class="panel panel-default ">
          <div class="panel-body">
            <img
              src="./images/Alumni/Argha.png"
          ...
          <div class="panel-footer">
            <p class="lead">
              <strong>Argha Chatoppadhyay</strong> Sound Cloud Berlin, Germany
              Salary: 72 Lacs Graduated in 2011
            </p>
          </div>
        </div>
        <div class="panel panel-default ">
          ...
          <div class="panel-footer">
            <p class="lead">
              <strong>Swijal Patil</strong><br />
              Amazon, <br />
              USA Salary: 60 Lacs Graduated in 2012
            </p>
          </div>
        </div>
        <div class="panel panel-default ">
          <div class="panel-body">
            <img
              src="./images/img-person-placeholder.jpg"
              class="img-responsive"
              alt=""
            />
          </div>
          <div class="panel-footer">
            <p class="lead">
              <strong>Harshal Borse</strong> <br />
              Entrepreneur Green Globe Biotechnologies Turnover: 2 Crore
            </p>
          </div>
        </div>
        <div class="panel panel-default ">
          ...
          <div class="panel-footer">
            <p class="lead">
              <strong>Shivanshi Shukla</strong> M.S at Michigan Tech University,
              USA
            </p>
          </div>
        </div>
      ...
      <div class="fullwidthbanner-container">
        <div class="fullwidthbanner">
          <ul>
            ...
            >
              <img
                src="./images/Reunions/Slide6.JPG"
                height="100%"
                width="100%"
                alt=""
              />
            ...
            >
              <img
                src="./images/Reunions/Slide5.JPG"
                height="100%"
                width="100%"
                alt=""
              />
            ...
            >
              <img
                src="./images/Reunions/Slide7.JPG"
                height="100%"
                width="100%"
                alt=""
              />
            ...
            >
              <img
                src="./images/Reunions/Slide8.JPG"
                height="100%"
                width="100%"
                alt=""
              />
    ...
    <div class="whatsapp" style="float: left;">
      ...
      <h5><img src="img/whatsapp.png" height="50px" width="50px"></h5></a>
      </div>
